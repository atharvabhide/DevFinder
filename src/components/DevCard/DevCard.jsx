    ...
    <>
        <div className={styles.card}>
            ...
            <div className={styles.socialLinks}>
                <Link to={props.hashnodeLink} className={styles.link}><SiHashnode size={23} /></Link>
                <Link to={props.twitterLink} className={styles.link}><BsTwitter size={23} /></Link>
                <a href={props.githubLink} target='_blank' className={styles.link}><GoMarkGithub size={23} /></a>
            </div>
            </div>
